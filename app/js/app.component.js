        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.mainHeading = config_service_1.Config.MAIN_HEADING; //"My Videos";
                    this.videos = [
                        new video_1.Video(1, 'VIDEO # 1', 'FIRST VIDEO', 'THIS IS FIRST VIDEO'),
                        new video_1.Video(2, 'VIDEO # 2', 'SECOND VIDEO', 'THIS IS SECOND VIDEO')
                    ];
                }
